...
axs[0,1].plot(df["x"],df["y0"],marker="x",color="black",linestyle="")
...
axs[0,0].plot(df["x"],df["resol_max"],color="red",linestyle="dashed")
axs[1,0] = df['y0'].plot.hist(ax=axs[1,0],bins=50)
axs[1,0].axvline( x = qNom[0], ymin=0,ymax=20,color='red',linestyle='dashed')
